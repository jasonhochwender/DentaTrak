...
try {
    ...
    if (!$preferences) {
        $preferences = [
            ...
            'coming_due_days' => 5,
            'highlight_appointment_risk' => true,
        ...
        if (!isset($preferences['highlight_appointment_risk'])) $preferences['highlight_appointment_risk'] = true;
        if (!isset($preferences['appointment_risk_days'])) $preferences['appointment_risk_days'] = 3;
