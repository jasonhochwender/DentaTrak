...
',
    ...
    'public_urls' => [
        ...
        'article_checklist'                     => 'dental-case-tracking-checklist',
        'article_case_mgmt_external_labs'       => 'dental-case-management-external-labs',
        'page_about'                            => 'about',
...
$appConfigUAT = array_merge($commonConfig, [
    ...
    'public_urls' => [
        ...
        'article_checklist'                     => 'dental-case-tracking-checklist.php',
        'article_case_mgmt_external_labs'       => 'dental-case-management-external-labs.php',
