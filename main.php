          ...
          <div class="analytics-pro">
            ...
            <div class="ap-section">
              <div class="ap-section-header">
                ...
                <div>
                  <h2 class="ap-section-title">Cases Created by User</h2>
                  <p class="ap-section-subtitle">Number of cases created by each user</p>
                </div>
              </div>

              <div class="ap-insights-grid" id="apCreatorBreakdown" style="min-height: 3rem;">
                <p class="insights-empty-state" id="apCreatorBreakdownEmpty" style="width: 100%;">No creator data available.</p>
              </div>
            </div>
